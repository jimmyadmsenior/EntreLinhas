    ...
    define('DB_USERNAME', 'root');  // Usuário do banco de dados InfinityFree
    define('DB_PASSWORD', '');  // Senha do banco de dados InfinityFree
    define('DB_NAME', 'entrelinhas');  // Nome do banco de dados InfinityFree
