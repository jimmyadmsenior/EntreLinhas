...
function registrar_notificacao_artigo($artigo, $destinatarios, $tipo_notificacao = "novo_artigo") {
    ...
    switch ($tipo_notificacao) {
        case 'novo_artigo':
            ...
            $conteudo .= "<p>Para revisar e aprovar este artigo, acesse o <a href='http://localhost:8000/PAGES/admin_dashboard.php'>Painel de Administração</a>.</p>";
            $conteudo .= "</body></html>";
            break;
        ...
        case 'status_alterado':
            ...
            $conteudo .= "<p>Para visualizar este artigo, acesse o <a href='http://localhost:8000/PAGES/artigo.php?id={$artigo['id']}'>link do artigo</a>.</p>";
            $conteudo .= "</body></html>";
            break;
