...
powershell -ExecutionPolicy Bypass -File .\deploy_completo.ps1

echo.
echo Se o script terminou com sucesso, seus arquivos estao prontos na pasta "deploy_pronto"
echo.
echo IMPORTANTE: Certifique-se de copiar TODOS os arquivos e pastas, inclusive os arquivos ocultos como .htaccess
echo.
pause
