...
function enviarEmailBoasVindas($nome, $email) {
    ...
    $mensagem .= "</ul>";
    $mensagem .= "<p>Para começar, acesse <a href='http://entrelinhas.infinityfreeapp.com/PAGES/enviar-artigo.php'>enviar artigo</a> e compartilhe sua primeira publicação!</p>";
